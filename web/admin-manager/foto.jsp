					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="margin: auto;">
							...
							<div class="card-header">
									<h3><i class="fa fa-check-square-o"></i>Foto añadida correctamente</h3>
								</div>
							<%
									BDController controladorbd=new BDController();
							
							int cod=controladorbd.calcularCod_candidato()-1;
...
//FOTO JUGADOR
			...
			//Creamos la ruta donde tenemos la aplicacion
			      ...
			      try{ 
			         ...
			         while ( i.hasNext () ) 
			         {
			            ...
			            if ( !fi.isFormField () )  {
			                ...
			                //añadimos a la ruta de la aplicacion la carpeta de las imagenes de jugadores y el nombre de la foto que sera
			                // el codigo del ultimo jugador dado de alta + la extension .png \admin-manager\assets\images\candidatos
			                file = new File( filePath + "admin-manager/assets/images/candidatos/" + controladorBD.calcularCod_candidato() + ".png") ;
			                // creamos el archivo
			                fi.write( file ) ;
			                System.out.println("Foto subida con exito: " + filePath + "admin-manager/assets/images/candidatos/" +controladorBD.calcularCod_candidato() + ".png" );
			            }
			         }
