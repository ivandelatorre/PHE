...
<head>
	...
	<title>Admin Site | Borrar Evento</title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="margin: auto;height:400px">
							<h3>Seleccione el evento a borrar</h3>
							<br/>
							<form action="borrarevento.jsp" >
								<div class="">
									<div class="mm-dropdown" style="background: white;cursor: pointer;font-size: 20px;font-weight: 200;line-height: 40px;height:53px">
										<div class="textfirst" style="border-color:#5c9cd8;border-radius: 5px;text-align:center">Selecciona Evento</div>
										<ul class="scrollable-menu"style="text-align:center">
											...
											%>
												<li class="input-option" data-value="  " style="border-color:#5c9cd8;">
													...
													<input type="hidden" class="option" name="codigo" value="<%=even.getCod_evento() %>" ><%=even.getNombre() %></input>
