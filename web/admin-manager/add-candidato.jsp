...
<head>
	...
	<title>Admin Site | AÃ±adir Candidatos</title>
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="margin: auto;">
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<form autocomplete="off" action="addcandidato.jsp">
										<div class="form-row">
											<div class="form-group">
												<label for="inputAddress">Datos Personales</label>
												<div class="input-group">
													<div class="input-group-prepend">
														<span class="input-group-text">Nombre y Apellidos</span>
													</div>
													<input type="text" name="nombre" aria-label="First name" required="" class="form-control" placeholder="Nombre">
													<input type="text" name="apellido" aria-label="Last name" required="" class="form-control" placeholder="Apellidos">
												</div>
											</div>
										</div>
										<div class="form-group">
											<label for="inputAddress">Fecha de Nacimiento</label>
											<input type="date" name="fecha" required="" class="form-control" id="inputAddress" style="max-width: 300px;">
											
											
										</div>
										<div class="form-group">
											<label for="inputAddress">Lugar de Nacimiento</label>
											<input type="text" name="lugar" required="" class="form-control" id="inputAddress" style="max-width: 300px;">
											
											
										</div>
										<div class="form-group">
											<label for="inputAddress">Autonomia</label>
											<input type="text" name="autonomia" required="" class="form-control" id="inputAddress" style="max-width: 300px;">
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												<input type="text" name="provincia" required="" class="form-control" id="inputCity">
											</div>
											<div class="form-group col-md-4">
												<label for="inputState">Ciudad</label>
												<select id="inputState" name="ciudad" class="form-control" required="">
										...
										<div class="form-group">
											<label for="inputZip">Añadir Imagen</label>
											<div class="input-group">
												<div class="input-group-prepend">
										...
										<div class="form-group">
											<label for="inputState">Campaña a la que se presenta</label>
											<select id="inputState" name="campana" class="form-control" required="">
										...
										<div class="form-group">
											<div class="form-check">
												<input class="form-check-input" name="cabeza" type="checkbox" required="">¿Cabeza de lista?
											</div>
											<br/>
											<div class="form-group col-md-2">
												<label for="inputZip">Posicion</label>
												<input type="number" name="posicion" class="form-control" required="" id="inputZip" placeholder="0">
											</div>
											</div><div class="form-group">
											<label for="exampleFormControlTextarea3">Descripción del candidato</label>
