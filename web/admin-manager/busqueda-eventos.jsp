					...
					<div class="row">
						<div class="col-xl-12">
							<div class="breadcrumb-holder">
								<h1 class="main-title float-left">Busqueda de eventos</h1>
								<ol class="breadcrumb float-right">
									<li class="breadcrumb-item">Inicio</li>
									<li class="breadcrumb-item active">Busqueda de eventos</li>
								</ol>
								<div class="clearfix"></div>
							</div>
						</div>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6" style="margin: auto;">
							<div class="card mb-3">
								<div class="card-header">
									<h3><i class="fa fa-table"></i> Busque el evento que desee </h3>
								</div>
									...
									<div class="table-responsive">
										<table id="example1" class="table table-bordered table-hover display">
											...
											for (int i = 0; i < eventos.size(); i++){%>
												...
												<tr>
													<td><%=eventos.get(i).getNombre()%></td>
													<td><%=eventos.get(i).getUbicacion()%></td>
													<td><%=eventos.get(i).getDia()%></td>
													<td><%=eventos.get(i).getHora()%></td>
													<td><%=eventos.get(i).getDescripcion()%></td>
													<td><%=eventos.get(i).getMunicipio()%></td>
												</tr>
												<% }%>
