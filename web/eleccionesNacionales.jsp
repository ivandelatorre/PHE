...
<head>
    ...
    <!-- Title -->
    <title>PHE | Elecciones Nacionales</title>
...
<%
    ...
    ArrayList<Programa> programas = controladorBD.dame10primerosPuntosPrograma("nacional");
    System.out.println(programas.get(0).getTitulo());
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Elecciones nacionales</a></li>
            </ol>
        </nav>
    </div>
            ...
            <div class="row team-items d-flex align-content-center justify-content-center">
                <div class="col-md-4 single-item">
                    <div class="item">
                        ...
                        <div class="thumb">
                            <img class="img-fluid" src="img/imagenesPoliticos/2.jpg" alt="Thumb">
                            <div class="overlay">
