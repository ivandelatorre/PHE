...
%>
    ...
    <div class="container">
        <h1 class="text-center mt-5 mb-5">Municipios</h1>
        <div class="card-deck justify-content-center">
            <a href="eMunicipales.jsp?municipio=pontevedra"><div class="card cardComunidad">
                <img class="card-img-top imagenComunidad" src="img/municipios/pontevedra.png" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title text-center">Pontevedra</h5>
                </div>
            </div></a>
            ...
            <a href="eMunicipales.jsp?municipio=granada"><div class="card cardComunidad">
                <img class="card-img-top imagenComunidad" src="img/municipios/granada.jpg" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title text-center">Granada</h5>
                </div>
            </div></a>
            <a href="eMunicipales.jsp?municipio=cuenca"><div class="card cardComunidad">
                <img class="card-img-top imagenComunidad" src="img/municipios/cuenca.png" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title text-center">Cuenca</h5>
                </div>
            </div></a>
        </div>
    </div>
