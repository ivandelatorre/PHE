...
<div class="tab-content container" id="myTabContent" style="max-width:750px;">
    ...
    <div class="tab-pane fade" id="asistir" role="tabpanel" aria-labelledby="profile-tab">
        ...
        <form class="text-center border border-light p-5" style="border:0px !important;" action="">
            ...
            <!-- Surnames -->
            <input type="text" id="apellidoEvento" name="" class="form-control mb-4" placeholder="Apellidos" required>
            ...
            <select class="browser-default custom-select mb-4">
                ...
                <option value=""><%=eventos.get(i).getNombre()%></option>
                <%}%>
            </select>
