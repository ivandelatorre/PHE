						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6" style="margin: auto;">
							<div class="card mb-3">
								<div class="card-header">
									<h3><i class="fa fa-check-square-o"></i> Nuevo Evento</h3>
								</div>

								<div class="card-body">

									<form autocomplete="off" action="addevento.jsp">
										<div class="form-row">
											<div class="form-group">
												<label for="inputAddress">Datos del Evento</label>
										...
										<div class="form-group">
											<label for="inputAddress">Dia del Evento</label>
											<input type="date" name="dia" required="" class="form-control" id="inputAddress" style="max-width: 300px;">
										</div>
										<div class="form-group">
											<label for="inputAddress">Hora del Evento</label>
											<input type="time" name="hora" required="" class="form-control" id="inputAddress" style="max-width: 300px;">
										</div>
										<div class="form-">
											<label for="inputCity">Lugar del Evento</label>
											<input type="text" name="lugar" required="" class="form-control" id="inputCity" placeholder="Estadio Municipal de Vallehermoso, Av. de Filipinas, 7, 28003 Madrid">
										</div>
										<div class="form-group">
