...
<%
    ...
    String fecha_nac = request.getParameter("fechaEvento");
    String email = request.getParameter("emailEvento");
    String telefono = request.getParameter("telfEvento");
    String campana = request.getParameter("campana");


    Voluntario voluntario = new Voluntario(nombre,apellidos, fecha_nac, email,telefono);
    controladorBD.insertarVoluntario(voluntario);
    int codA = controladorBD.dameIdUltimoVoluntario();
    controladorBD.insertarAsistentes(codA, Integer.parseInt(campana));
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Evento creado</li>
            </ol>
        </nav>
    </div>

    <div class="container">
        <h2>El siguiente usuario va a ir a la campaña : <%=campana%></h2>
